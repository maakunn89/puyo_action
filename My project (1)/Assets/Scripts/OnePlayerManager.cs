...
public class OnePlayerManager : MonoBehaviour
{
    ...
    Rigidbody2D rb;
    Animator animator;
    TwoPlayerManager twoPlayerManager;
    GroundCheck ground;
    TwoPlayerManager enemyScript;
    ...
    void Start()
    {
        ...
        hp = maxHp;
        enemy = GameObject.Find("TwoPlayer");
        enemyScript = enemy.GetComponent<TwoPlayerManager>();
    ...
    void Update()
    {
        ...
        if(isDead){
            ...
            if (isGround){
                ...
                if (Input.GetKeyDown(KeyCode.W) && !airJumped){
                    AirJump();
                }
                else{
                    MovementInAir();
    ...
    public void Attack1()
    {
        ...
        {
            twoPlayerManager = hitEnemy.GetComponent<TwoPlayerManager>();
            if(twoPlayerManager){
                twoPlayerManager.OnDamage(10);
            }
        }
    }
    ...
    void Die()
    {
        ...
        if (twoPlayerManager.isDead == true) {
            GameVariableStatic.winner = "both";
        } else {
            GameVariableStatic.winner = "2P";
        }
    }
